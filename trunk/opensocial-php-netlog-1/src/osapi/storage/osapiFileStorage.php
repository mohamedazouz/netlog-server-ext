...
class osapiFileStorage extends osapiStorage {
  ...
  private function getStorageFile($hash) {
  	$dir = $this->getStorageDir($hash) . '/' . $hash;

	/*
  	// open this directory @WOUTER
	...
	closedir($myDirectory);
  	...
  	die("Storage dir contains:" . print_r($dirArray, true));
  	*/
    return $dir;
  }

  public function get($key, $expiration = false) {
  	//die("Getting key from filestorage: " . $key);
