...
switch ($test) {
  ...
  case 'netlog':
		...
		$osapi = new osapi($provider, new osapiOAuth2Legged("605776b05bad192d854121de477238a7", "b63bf18647211c8fd7155331c0daedd3e"));
		*/
			$key = '83f4922f992b3d6f47db15b3da5ef4ac';
	$secret = '95103ccb91eac5656ce977b6e79ec048';
		 $provider = new osapiNetlogProvider();
		$provider->rpcEndpoint = null;
		$auth = osapiOAuth3Legged::performOAuthLogin($key, $secret, $storage, $provider, $localUserId);
		$osapi = new osapi($provider, $auth);
    break;
  case 'hi5':
    $userId = '167259949';
